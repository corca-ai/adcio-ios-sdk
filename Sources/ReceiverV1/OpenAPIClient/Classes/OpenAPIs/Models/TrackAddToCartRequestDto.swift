...
public struct TrackAddToCartRequestDto: Codable, JSONEncodable, Hashable {
    ...
    public init(storeId: String, sessionId: String, deviceId: String, customerId: String? = nil, requestId: String? = nil, productIdOnStore: String? = nil, adsetId: String? = nil, categoryIdOnStore: String? = nil, cartId: String? = nil, quantity: Double? = nil) {
