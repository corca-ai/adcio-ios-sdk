...
public struct CreateProductDto: Codable, JSONEncodable, Hashable {
    ...
    public init(idOnStore: String, name: String, price: Double, summary: String, image: String, includeInRecommendation: Bool? = nil, sellerId: String? = nil, sellerIdOnStore: String? = nil, url: String? = nil, deepLink: String? = nil, caption: String? = nil) {
