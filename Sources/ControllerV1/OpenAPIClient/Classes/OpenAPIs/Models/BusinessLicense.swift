...
public struct BusinessLicense: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, companyName: String?, licenseNumber: String?, fileUrl: String, inspectionStatus: InspectionStatus, createdAt: Date, updatedAt: Date, deletedAt: Date?) {
        self.id = id
