//
// ClientWithBusinessLicenseDto.swift
//
...
public struct ClientWithBusinessLicenseDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, name: String, currency: Currency, timezone: Timezone, paidCredit: Double, freeCredit: Double, type: ModelType, deletedAt: Date?, paymentCardId: String?, storeId: String?, businessLicenseId: String?, isSeller: Bool, createdAt: Date, businessLicense: BusinessLicense? = nil) {
        self.id = id
        self.name = name
