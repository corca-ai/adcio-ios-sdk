//
// CreateWidgetPlacementResponseDto.swift
//
...
public struct CreateWidgetPlacementResponseDto: Codable, JSONEncodable, Hashable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(widgetValue, forKey: .widgetValue)
    }
}
