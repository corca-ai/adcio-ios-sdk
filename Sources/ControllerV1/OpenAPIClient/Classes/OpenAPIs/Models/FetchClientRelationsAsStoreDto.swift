//
// FetchClientRelationsAsStoreDto.swift
//
...
public struct FetchClientRelationsAsStoreDto: Codable, JSONEncodable, Hashable {
    ...
    public init(seller: Client, id: String, storeId: String, sellerId: String, sellerIdOnStore: String, invitationId: String?, createdAt: Date, deletedAt: Date?) {
        self.seller = seller
        self.id = id
