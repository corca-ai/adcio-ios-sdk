...
public struct TimeSeriesAdMetric: Codable, JSONEncodable, Hashable {
    ...
    public init(creditUsage: AmountMetric, revenue: AmountMetric, roas: FigureMetric, impression: CountMetric, click: CountAndFigureMetric, purchase: CountAndFigureMetric, date: Date) {
