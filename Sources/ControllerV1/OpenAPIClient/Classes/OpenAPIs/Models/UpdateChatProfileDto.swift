...
public struct UpdateChatProfileDto: Codable, JSONEncodable, Hashable {
    ...
    public init(imageUrl: String? = nil, name: String, description: String? = nil, domain: Domain? = nil, theme: Theme, language: Language? = nil, activated: Bool, greetingMessage: String? = nil, bottomMargin: Double? = nil) {
