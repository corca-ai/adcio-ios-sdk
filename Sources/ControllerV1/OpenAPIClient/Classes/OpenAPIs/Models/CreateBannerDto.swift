...
public struct CreateBannerDto: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String, type: ModelType, creatives: [UpsertCreativeDto], placementIds: [String], url: String? = nil, data: AnyCodable, deepLink: String?, appRoute: String?, startsAt: Date, endsAt: Date? = nil, categoryId: String?, productId: String?) {
        self.name = name
        self.type = type
