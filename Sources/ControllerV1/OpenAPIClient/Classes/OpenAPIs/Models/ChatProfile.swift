...
public struct ChatProfile: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, clientId: String, imageUrl: String?, name: String, description: String, domain: Domain, theme: Theme, language: Language, activated: Bool, greetingMessage: String, bottomMargin: Double, createdAt: Date) {
        self.id = id
