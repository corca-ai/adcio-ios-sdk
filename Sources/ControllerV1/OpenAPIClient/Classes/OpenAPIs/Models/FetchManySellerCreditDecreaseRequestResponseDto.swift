//
// FetchManySellerCreditDecreaseRequestResponseDto.swift
//
...
public struct FetchManySellerCreditDecreaseRequestResponseDto: Codable, JSONEncodable, Hashable {
    ...
    public init(seller: Client, id: String, storeId: String, sellerId: String, amount: Double, requestedAt: Date, reason: String, rejectionReason: String?, status: Status, processedAt: Date?, creditHistoryId: String?) {
        self.seller = seller
        self.id = id
