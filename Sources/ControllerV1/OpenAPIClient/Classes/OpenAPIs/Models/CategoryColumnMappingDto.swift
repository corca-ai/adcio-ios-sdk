//
// CategoryColumnMappingDto.swift
//
...
public struct CategoryColumnMappingDto: Codable, JSONEncodable, Hashable {
    ...
    public init(idOnStore: String, name: String, depth0Id: String? = nil, depth1Id: String? = nil, depth2Id: String? = nil, depth3Id: String? = nil, depth4Id: String? = nil) {
