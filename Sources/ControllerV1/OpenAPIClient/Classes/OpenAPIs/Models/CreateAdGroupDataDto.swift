...
public struct CreateAdGroupDataDto: Codable, JSONEncodable, Hashable {
    ...
    public init(maxBudgetPerDay: Double? = nil, totalBudgetInPeriod: Double? = nil, budgetType: AdGroupBudgetType, title: String, type: ModelType, placementId: String, productIds: [String]? = nil, bannerIds: [String]? = nil, startsAt: Date, endsAt: Date? = nil, targetValueIds: [String]) {
